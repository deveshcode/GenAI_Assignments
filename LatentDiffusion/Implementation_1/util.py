...
def save_images(images: torch.Tensor, dest_path: str, prefix: str = '', img_format: str = 'jpeg', save_intermediate: bool = True):
    """
    ### Save images
    ...
    :param save_intermediate: whether to save the intermediate torch tensor
    """
    # Create the destination folder
    os.makedirs(dest_path, exist_ok=True)

    # Save the intermediate torch tensor if required
    if save_intermediate:
        intermediate_dest_path = os.path.join(dest_path, f"{prefix}intermediate.pt")
        torch.save(images, intermediate_dest_path)
