...
class Txt2Img:
    ...
    def __call__(self, *,
        ...
        dest_path = "/Users/deveshsurve/UNIVERSITY/PROJECT/annotated_deep_learning_paper_implementations/labml_nn/diffusion/stable_diffusion/scripts"
        # AMP auto casting
...
def main():
    ...
    with monit.section('Generate'):
        txt2img(dest_path='outputs', batch_size=opt.batch_size, prompt=opt.prompt,uncond_scale=opt.scale)
